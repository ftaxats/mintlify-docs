...
[​](https://docs.getinboxzero.com/essentials/cold-email-blocker#custom-prompts)
Custom Prompts
--------------
...
[​](https://docs.getinboxzero.com/essentials/cold-email-blocker#testing)
Testing
-------

To test how well the cold email blocker is working, click the `Test` button. A side panel will open, and you can paste in an email to see if it would be marked as a cold email. You can also test previous emails that appear in the side panel.

[​](https://docs.getinboxzero.com/essentials/cold-email-blocker#how-we-classify-cold-emails)
