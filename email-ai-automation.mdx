...
On the [Rules](https://mailto.live/automation?tab=rules) page, you can view and edit your rules.
...
`Hi {{name}}, {{write a response expressing interest in their proposal and ask about their timeline}}
Best regards`
...
You can test your rules by going to the [Test](https://mailto.live/automation?tab=test) tab.
