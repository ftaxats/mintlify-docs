...
When `Automated` mode is disabled, the AI will not apply any actions, but the planned action will appear in the [Planned](https://mailto.live/automation?tab=planned) tab where you can approve or reject the action.
